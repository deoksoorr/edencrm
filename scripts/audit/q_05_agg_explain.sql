...
FROM information_schema.STATISTICS WHERE TABLE_SCHEMA=DATABASE() AND TABLE_NAME LIKE 'edencrm\_%'
...
WHERE k.TABLE_SCHEMA=DATABASE() AND k.TABLE_NAME LIKE 'edencrm\_%' AND k.REFERENCED_TABLE_NAME IS NOT NULL
...
WHERE t.TABLE_SCHEMA=DATABASE() AND t.TABLE_NAME LIKE 'edencrm\_%' AND t.COLUMN_NAME='deleted_at'
---
