...
<div class="page">
  ...
  <div class="card pad mb-14">
    ...
    <div class="grid-2">
      <div class="goal">
        <div class="goal-top">
          <span class="section-desc">매출 달성률</span>
        ...
        <div class="goal-meta">
          <div class="kv"><span class="kv-label">현재</span><span class="kv-value mono" title="<?= e(money($s['month_revenue']) . '원') ?>"><?= e(moneyShort($s['month_revenue'])) ?></span></div>
          <div class="kv"><span class="kv-label">목표</span><span class="kv-value mono" title="<?= e(money($s['target_revenue']) . '원') ?>"><?= e(moneyShort($s['target_revenue'])) ?></span></div>
          <div class="kv"><span class="kv-label">남은 금액</span><span class="kv-value mono"><?= e(moneyShort($revRemain)) ?></span></div>
        </div>
      </div>
      <div class="goal">
        <div class="goal-top">
        ...
        <div class="goal-meta">
          <div class="kv"><span class="kv-label">현재</span><span class="kv-value mono" title="<?= e(money($s['month_profit']) . '원') ?>"><?= e(moneyShort($s['month_profit'])) ?></span></div>
          <div class="kv"><span class="kv-label">목표</span><span class="kv-value mono" title="<?= e(money($s['target_profit']) . '원') ?>"><?= e(moneyShort($s['target_profit'])) ?></span></div>
          <div class="kv"><span class="kv-label">남은 금액</span><span class="kv-value mono"><?= e(moneyShort($proRemain)) ?></span></div>
        </div>
      </div>
    </div>
  </div>
