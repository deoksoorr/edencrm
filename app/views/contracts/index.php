...
<div class="page">
  <div class="page-head">
    <div>
      <h1 class="page-title">계약 관리<?php if ($filters['trash']): ?> <span class="badge badge-muted">휴지통</span><?php endif; ?></h1>
      ...
      <table class="data">
        ...
        <tbody>
          <?php foreach ($rows as $r): $ended = in_array($r['status'], ['terminated', 'cancelled'], true); ?>
            <tr>
              <td><?php if ($filters['trash']): ?><?= e($r['contract_no']) ?><?php else: ?><a href="<?= e(url('contracts.show', ['id' => $r['id']])) ?>"><?= e($r['contract_no']) ?></a><?php endif; ?></td>
