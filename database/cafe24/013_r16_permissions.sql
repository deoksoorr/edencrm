...
-- 운영(카페24 공유 DB, prefix edencrm_). 로컬은 database/migrations/2026-07-29_r16_permissions.sql.
...
CREATE TABLE IF NOT EXISTS `edencrm_employee_permissions` (
  ...
  CONSTRAINT `fk_edencrm_emp_perm_user`    FOREIGN KEY (`user_id`)    REFERENCES `edencrm_users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_edencrm_emp_perm_updater` FOREIGN KEY (`updated_by`) REFERENCES `edencrm_users` (`id`) ON DELETE SET NULL
